...
router.get('/billing/review', indexController.billingReview);
router.get('/billing/review/checkout', indexController.billingReviewCheckout);
router.get('/billing/review/gateway', indexController.billingReviewGateway);
router.get('/billing/review/complete', indexController.billingReviewComplete);
